...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '7b356b4e61fb41439d1add2f2e348d28',
  ...
  GREETING_WORDS:
    ...
    '你好呀，旅行者。我是YAO，是你未来的同行者。欢迎来到新的天地！在新的旅途开启之前，YAO先给你讲个故事吧。那是一个来自遥远的过去，关于“编程”的故事。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yaojunluo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的前端开发(划水，摸鱼，码代码)', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://next.yaojunluo.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'yaojunluo, 博客, next', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yaojunluo@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/yaojunluo', // 你的github个人主页 例如 https://github.com/tangly1024
